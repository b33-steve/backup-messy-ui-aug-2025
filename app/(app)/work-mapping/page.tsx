        ...
        <CardHeader className="pb-3">
          ...
          <div className="flex items-center justify-between mt-2">
            <div className="flex items-center gap-4 text-sm">
              <div className="flex items-center gap-1">
                ...
                <span className="text-muted-foreground">Value: {initiative.businessValue}/10</span>
              </div>
              <div className="flex items-center gap-1">
                <Clock className="h-4 w-4 text-orange-400" />
                <span className="text-muted-foreground">Effort: {initiative.effort}/10</span>
              </div>
              <div className="flex items-center gap-1">
                <Zap className="h-4 w-4 text-green-400" />
                <span className="text-muted-foreground">{initiative.confidence}% confident</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-2">
            <div className="flex items-center justify-between text-sm mb-1">
              ...
              <span className="text-muted-foreground">{initiative.progress}%</span>
            </div>
