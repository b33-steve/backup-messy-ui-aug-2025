...
import { Container, Grid, Title, Text, Group, Stack, Badge, SimpleGrid, Box, Anchor, Button } from '@mantine/core';
...
export default function PM33MarketingHomePage() {
  ...
  return (
    ...
    >
      ...
      {/* OLD CTA Section - COMMENTED OUT (had white text issues + missing PM33 components) */}
      {/*
      <Container size="xl" py={80}>
        <PM33Card 
          variant="ai" 
      ...
      */}
      ...
      {/* Final CTA Section - Clean White Background with Dark Text */}
      <Box style={{ backgroundColor: '#ffffff', borderTop: '1px solid var(--mantine-color-gray-2)' }}>
        <Container size="xl" py={80}>
          <Stack align="center" gap={32}>
            <Stack align="center" gap={16} maw={800}>
              ...
              <Text 
                ...
                maw={600}
              >
                Join 2,500+ Product Managers using PM33's AI teams to get PMO-level strategic capabilities. 
            ...
            <Group gap={32} mt={24}>
              ...
              <Group gap={8}>
                <IconCircleCheck size={18} color="var(--mantine-color-green-6)" />
                <Text size="sm" c="dimmed">Works with existing tools</Text>
              </Group>
            </Group>
          </Stack>
        </Container>
