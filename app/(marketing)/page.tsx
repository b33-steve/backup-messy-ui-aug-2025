          ...
          <Group justify="center" gap={32} mt={48}>
            <Button 
              ...
              onClick={() => {
                ...
                trackCAC.signupStarted('homepage_hero', window.location.href);
              }}
            >
            ...
            <Button 
              ...
              onClick={() => {
                ...
                trackCAC.signupStarted('homepage_demo', window.location.href);
              }}
            >
              See Live Demo
            </Button>
          ...
          <Group justify="center" gap={32}>
            <Button 
              ...
              onClick={() => {
                ...
                trackCAC.signupStarted('homepage_final_cta', window.location.href);
              }}
            >
