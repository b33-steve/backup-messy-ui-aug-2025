...
# PM33 ULTIMATE UI/UX SYSTEM

# MANDATORY: This is the SINGLE SOURCE OF TRUTH for all UI/UX decisions

# PURPOSE: Transform PM33 into an industry-leading strategic intelligence platform

# ENFORCEMENT: Every UI component must pass these standards or be rejected
...
```css
/* PM33 Premium Color Palette - COPY THIS EXACTLY */
:root {
  ...
  /* Dark Mode Surfaces */
  --pm33-dark-0: #0a0e27;  /* Deep background */
  --pm33-dark-1: #0f1429;  /* Card background */
  --pm33-dark-2: #151b3b;  /* Elevated surface */
  --pm33-dark-3: #1e2749;  /* Hover surface */
  
  /* Light Mode Surfaces */
  --pm33-light-0: #fafbff;  /* Soft background */
  --pm33-light-1: #ffffff;  /* Pure white */
...
const AIProcessingState = ({ message = "Analyzing strategic implications..." }) => (
  <div className="flex flex-col items-center justify-center p-12">
    ...
    <div className="relative w-32 h-32 mb-8">
      ...
      {/* Core brain icon */}
      <div className="relative w-32 h-32 rounded-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center shadow-2xl"
           style={{ 
    ...
    <div className="w-64 h-1 bg-gray-700 rounded-full mt-4 overflow-hidden">
      <div className="h-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-full"
           style={{
             width: '30%',
...
test.describe('PM33 UI Compliance', () => {
  ...
  test('Premium quality metrics', async ({ page }) => {
    ...
    await page.screenshot({ path: 'ui-quality-check.png', fullPage: true });
  ...
  return (
    <PM33PageWrapper>
      ...
      <div style={{
        ...
        {isProcessing && <PM33AIProcessing message="Analyzing your request..." />}
      </div>
    </PM33PageWrapper>
  );
}
